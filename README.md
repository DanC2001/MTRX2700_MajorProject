...
Presentation slides, including system diagrams and further information on each module:
...
## PWM & Servomotors
      ...
      Limitations
            ...
            * Full range of motion of the servos is limited from 0 to 180 degrees
      Testing
...
## Timer
      ...
      Testing
            ...
            * Test the overflow by enabling the overflow then checking its value after a few seconds to see it ahs increased. (or place breakpoint into the 
            interrupt)
